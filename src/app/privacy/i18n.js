      ...
      topics: [
        {
          ...
          content: [
            ...
            'Die Nutzung unserer Webseite ist in der Regel ohne Angabe personenbezogener Daten möglich. Soweit auf unseren Seiten personenbezogene Daten (beispielsweise Name, Anschrift oder E-Mail-Adressen) erhoben werden, erfolgt dies, soweit möglich, stets auf freiwilliger Basis. Diese Datenwerden ohne Ihre ausdrückliche Zustimmung nicht an Dritte weitergegeben.',
            'Wir weisen darauf hin, dass die Datenübertragung im Internet (z.B. bei der Kommunikation per E-Mail) Sicherheitslücken aufweisen kann. Ein lückenloser Schutz der Daten vor dem Zugriffdurch Dritte ist nichtmöglich.'
          ]
        },
        {
        ...
        },
        {
          ...
          content: [
            'Sie haben jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung sowie ein Recht auf Berichtigung, Sperrung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit unter der im Impressum angegebenen Adresse des Berliner Büros an uns wenden.'
          ]
        },
        {
    ...
    privacy: {
      ...
      topics: [
        ...
        },
        {
          ...
          content: [
            'In the context of the commentary function, we collect personal data (eg name, e-mail) only to answer your comment/s on a contribution of ours. When you publish a comment, the email address you provide is saved but not published. Your name will be published if you have not written under pseudonym.'
          ]
        },
        {
          title: 'Privacy Policy for the Facebook plug-in (“Like”)',
          content: [
            'This website uses plug-ins from the Facebook.com company, which are provided by the company Facebook Inc., 1601 S. California Avenue, Palo Alto, CA 94304 in the USA. Users of our website, on which the Facebook plugin (“like” button) is installed, are hereby informed that the plugin connects to Facebook, whereby a transmission to your browser is carried out, so the plugin on The web page.',
            'Furthermore, the usage data is passed on to the Facebook servers, which contain information about your website visits on our homepage. For logged in Facebook users, this means that the usage data is assigned to your personal Facebook account.',
            'If you are actively using the Facebook plug-in as a logged-in Facebook user (for example, by clicking the “Like” button or using the comment feature), this data will be transferred to your Facebook account and published. This can only be done by logging out of your Facebook account.',
            'For more information on Facebook’s data usage, please refer to the Privacy Policy on Facebook at http://de-en.facebook.com/policy.php.'
          ]
        },
        {
          ...
          content: [
            ...
            'We are not aware of the content of the transmitted data and its use by Twitter. For more information, please visit Twitter’s privacy policy: http://twitter.com/privacy',
            'Follow the link below to setup your privacy settings: http://twitter.com/account/settings.'
          ]
        },
        {
